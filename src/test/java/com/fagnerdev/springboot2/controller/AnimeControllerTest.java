package com.fagnerdev.springboot2.controller;
...
import com.fagnerdev.springboot2.service.AnimeService;
import com.fagnerdev.springboot2.util.AnimeCreator;
import com.fagnerdev.springboot2.util.AnimePostRequestBodyCreator;
import com.fagnerdev.springboot2.util.AnimePutRequestBodyCreator;
...
class AnimeControllerTest {
    ...
    void list_ReturnsLisftOfAnimeInsidePageObject_WhenSuccessful(){
    ...
    void listAll_ReturnsLisftOfAnimes_WhenSuccessful(){
    ...
    void findByName_ReturnsEmptyListOfAnime_WhenAnimeNotFound(){
        ...
        //Quando se refere a um método não bem sucedido, localizamos este método dentro do próprio método
        BDDMockito.when(animeServiceMock.findByName(ArgumentMatchers.anyString()))
    ...
    @Test
    @DisplayName("update returns anime updated when sucessful")
    void update_ReturnsAnimeUpdated_WhenSuccessful(){
